...
from V_train_compo_gen import collate
from utils.utils import parse_args_and_config, get_scaler_mean_std, last_ckpt, check_save_num
from components.cond_gen_ft.dataloader import CrystalDataset
...
def train(rank, world_size, args, config):
    ...
    train.scaler = get_scaler_mean_std("cond_gen", args.dataset)
    ...
    ckpt = last_ckpt("cond_gen", args.dataset)
...
if __name__ == '__main__':
    args, config = parse_args_and_config("cond_gen_ft")
